        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <p>
                        Lonam adalah salah satu desa di Kecamatan Pemangkat, Kabupaten Sambas.
                    </p>
                </div>
                <!-- Quick Links Section -->
                <div class="col-md-4 mb-4">
            ...
            <div class="text-center">
                <p class="mb-0">Copyright &copy; 2024 Desa Lonam. All rights reserved.</p>
            </div>
        </div>
    </footer>
    <!-- End of Footer -->
