...
@section('child')
        ...
        <div class="container-fluid banner-image w-100 vh-100 d-flex justify-content-center align-items-center">
            <div class="row">
                <div class="text-center">
                    ...
                    <h2 class="text-banner-h1">Website Desa Lonam</h2>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="content" class="py-5">
        <div class="container-fluid transition-container col-lg-10 shadow-sm p-4 rounded">
            <h2 class="subjudul mb-4 text-center fw-bold">Tentang Desa Lonam</h2>
        ...
        <div class="container-fluid transition-container col-lg-10 shadow-sm p-4 rounded">
            ...
            <div class="row mb-4 justify-content-center text-center">
                <div class="col-12">
                    ...
                    <p class="text-muted">Berkenalan dengan perangkat desa yang mendukung kemajuan Desa Lonam.</p>
                </div>
            </div>
